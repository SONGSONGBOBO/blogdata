    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://github.com/SONGSONGBOBO/blogdata/tree/master/min_photos/' + data.link[i];
          var src = 'https://github.com/SONGSONGBOBO/blogdata/tree/master/photos/' + data.link[i];
          var type = data.type[i];
          var target = src + (type === 'video' ? '.mp4' : '.jpg');
          src += '';

          liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope="" itemtype="https://github.com/SONGSONGBOBO/blogdata/tree/master/min_photos/">\
      ...
      document.querySelector('.instagram').innerHTML = '<div class="photos" itemscope="" itemtype="https://github.com/SONGSONGBOBO/blogdata/tree/master/photos/">' + ulTmpl + '</div>';
      createVideoIncon();
      _view2.default.init();
    };
